...
//                PRINTVAR( line );
            ...
            normals.push_back(vec3d{0.0f, 0.0f, 0.0f});
        ...
        if ( line[0] == 'f' )
        {
            ...
            //*********************************************************************
            vec3d faceNormal = computeNormal(vertices[t.v1], vertices[t.v2], vertices[t.v3]);


            //*********************************************************************
            // Sum the normal of the face to each vertex normal (to be done for section 5.3)
            //*********************************************************************
            normals[t.v1] += angleAtVertex(vertices[t.v1], vertices[t.v2], vertices[t.v3]) * faceNormal;
            normals[t.v2] += angleAtVertex(vertices[t.v2], vertices[t.v3], vertices[t.v1]) * faceNormal;
            normals[t.v3] += angleAtVertex(vertices[t.v3], vertices[t.v1], vertices[t.v2]) * faceNormal;
