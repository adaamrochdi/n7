                   ...
                   const RenderingParameters& params)
{
    ...
    if(!params.smooth)
    {
        ...
        for (const face& f : mesh) 
        {
            ...
            vec3d faceNormal = computeNormal(vertices[f.v1], vertices[f.v2], vertices[f.v3]);
            glNormal3fv((float*)&faceNormal);
    ...
    else
    {
        ...
        for (const face& f : mesh)
        {
            ...
            glNormal3fv((float*)&vertexNormals[f.v1]);
            glVertex3fv((float*)&vertices[f.v1]);
        
            glNormal3fv((float*)&vertexNormals[f.v2]);
            glVertex3fv((float*)&vertices[f.v2]);

            glNormal3fv((float*)&vertexNormals[f.v3]);
            glVertex3fv((float*)&vertices[f.v3]);
                     ...
                     const RenderingParameters& params)
{
    ...
    // Draw the faces
    //****************************************
    glDrawElements(GL_TRIANGLES, 3 * indices.size(), GL_UNSIGNED_INT, (unsigned int*)&indices[0]);
