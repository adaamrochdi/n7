...
[y_bruit_parole, ~] = audioread('talking.mp3');
...
if numero_reconnu == numero_morceau
    fprintf('Le morceau "%s" a été correctement reconnu avec un décalage temporel de %.2f secondes !\n', fichiers(numero_morceau).name, (meilleur_offset/f_ech) * n_decalage);
else
