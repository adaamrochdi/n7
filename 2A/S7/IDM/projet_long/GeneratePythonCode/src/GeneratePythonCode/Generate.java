...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/GeneratePythonCode/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(TablePackage.class)) {
            // Enregistrement normal si le métamodèle est dans un plugin externe
