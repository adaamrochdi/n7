...
public class TableItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TablePackage.Literals.TABLE__TABLESOURCE);
			childrenFeatures.add(TablePackage.Literals.TABLE__TABLERESULTANTE);
			childrenFeatures.add(TablePackage.Literals.TABLE__SCRIPT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TablePackage.Literals.TABLE__TABLESOURCE,
				 TableFactory.eINSTANCE.createTableSource()));

		newChildDescriptors.add
			(createChildParameter
				(TablePackage.Literals.TABLE__TABLERESULTANTE,
				 TableFactory.eINSTANCE.createTableResultante()));

		newChildDescriptors.add
			(createChildParameter
				(TablePackage.Literals.TABLE__SCRIPT,
				 TableFactory.eINSTANCE.createScript()));
	}
