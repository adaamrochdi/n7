...
(*variables globales*)
type varglobale = Globale of typ * string * expression
(* Instructions de Rat *)
type bloc = instruction list
and instruction =
  (* Déclaration de variable représentée par son type, son nom et l'expression d'initialisation *)
  | Declaration of typ * string * expression
  (* Affectation d'un affectable représenté par son nom et la nouvelle valeur affectée *)
...
type programme = Programme of varglobale list * fonction list * bloc
...
struct
 ...
 type varglobale = Globale of typ * Tds.info_ast * expression
...
type varglobale = Globale of Tds.info_ast * expression
...
type varglobale = Globale of Tds.info_ast * expression * int 
