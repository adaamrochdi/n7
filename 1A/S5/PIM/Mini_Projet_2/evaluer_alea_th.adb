...
procedure Evaluer_Alea_TH is
    	...
    	-- la foction identité
	function Fonction_identite(Cle: in Integer) return Integer is
	begin
		return Cle;
    end Fonction_identite;

     package TH_nouveau is
            new TH (Capacity => 1000, T_Cle =>  Integer, T_Valeur => Integer, Hachage => Fonction_identite);
    use TH_nouveau;
	...
	is
        ...
        procedure Trouver_Max_Min is new Pour_Chaque_TH(Traiter_Min_Max);
    ...
    begin
        ...
        for i in 1..Taille loop
            ...
            if Cle_Presente( Sda, Rand ) then
                Enregistrer( Sda, Rand, La_Valeur(Sda, Rand) + 1);
            else
