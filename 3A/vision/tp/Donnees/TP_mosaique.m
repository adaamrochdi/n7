...
figure;
affichage_image(uint8(Imoscoul),'Mosaique obtenue a partir des 2 images couleur initiales',1,1,1);
...
% 2.4. Appel de la fonction de mosaïque à 3 images (à implémenter)
Imos3_coul = mosaique3(Im1_coul, Im2_coul, Im3_coul, H_1_2, H_2_3);
affichage_image(uint8(Imos3_coul),'Mosaique obtenue a partir des 3 images couleur initiales ',1,1,1);


I_list = {Im1_coul, Im2_coul, Im3_coul};
...
figure;
affichage_image(uint8(ImosN_coul),'Mosaique N=3 obtenue a partir des 3 images couleur initiales',1,1,1);