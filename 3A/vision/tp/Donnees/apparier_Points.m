...
%% A COMPLETER %%
%%%%%%%%%%%%%%%%%
vois1_moy=mean(vois1,2);
vois2_moy=mean(vois2,2);
...
%% A COMPLETER %%
%%%%%%%%%%%%%%%%%
vois1_var=var(vois1,0,2);
vois2_var=var(vois2,0,2);
...
%% A COMPLETER %%
%%%%%%%%%%%%%%%%%
vois1_c = vois1(i1,:) - vois1_moy(i1);
vois2_c = vois2(i2,:) - vois2_moy(i2);
cov = sum(vois1_c .* vois2_c, 2) / NbPix;
...
%% A COMPLETER %%
%%%%%%%%%%%%%%%%%
den = sqrt(vois1_var(i1) .* vois2_var(i2));
cor = cov ./ den;
