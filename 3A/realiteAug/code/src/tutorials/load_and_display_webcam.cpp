...
int main(int argc, char** argv)
{
    ...
    cout << "FRAME_WIDTH: " << capture.get(cv::CAP_PROP_FRAME_WIDTH) << endl;
    cout << "FRAME_HEIGHT: " << capture.get(cv::CAP_PROP_FRAME_HEIGHT) << endl;
    cout << "FOURCC: " << capture.get(cv::CAP_PROP_FOURCC) << endl;
